...
\usepackage[
  alf,
  abnt-nbr10520=1988,                     % Citações em sentence case
  abnt-emphasize=bf
  ]{abntex2cite}
...
% Pacotes adicionais
% ---
\usepackage{pdfpages}	% Inclusão de páginas em PDF


% ---
% Informações para CAPA e FOLHA DE ROSTO
% ---
\titulo{APRENDIZAGEM DE MÁQUINA PARA PREDIÇÃO DE DESFECHOS EM SAÚDE MENTAL: \textmd{UMA INTRODUÇÃO PARA PSICÓLOGOS}}
...
\makeatletter
\hypersetup{
		pdftitle={Aprendizagem de máquina para predição de desfechos em saúde mental: uma introdução para psicólogos}, 
		pdfauthor={Guilherme Augusto Dias},
    	pdfsubject={\imprimirpreambulo},
	    pdfcreator={LaTeX with abnTeX2},
		pdfkeywords={aprendizagem de máquina}{psicoterapia}{psicologia positiva}{depressão}, 
...
\begin{folhadeaprovacao}
  \begin{center}
   ...
   \assinatura{Prof. Ma. Caroline Santa Maria Rodrigues -- PUCRS}
   \assinatura{Prof. Dra. Clarissa Pinto Pizarro de Freitas -- PUCRS}
   \assinatura{\imprimirorientador -- PUCRS}
\end{folhadeaprovacao}
% ---
...
% \printindex
%---------------------------------------------------------------------
\includepdf{./05-extras/contracapa.pdf}
\end{document}
